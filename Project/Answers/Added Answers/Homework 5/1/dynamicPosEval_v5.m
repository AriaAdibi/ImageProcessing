function [E_last, lastIndx, par]= dynamicPosEval_v4(points, st, Gmag, m, OO, alpha, gamma, avgD)
    nP= size(points, 1);
    nStates= m^2;
    ...
    for r=1:nP-1
        for i=1:nStates
            ...
            for j=1:nStates
                ...
                e= gamma*(-( Gmag(movedP(1), movedP(2))^2 )) + ...
                       alpha * ( sqrt(sum((movedP-movedQ).^2)) - avgD )^2;
                %evaluate E(v, i)
